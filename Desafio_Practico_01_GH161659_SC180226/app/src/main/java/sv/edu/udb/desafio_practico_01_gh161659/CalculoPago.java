...
public class CalculoPago extends AppCompatActivity {
        ...
        btnCalcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else  if ("".equals(TxtApellido1.getText().toString()))
                {
                    ...
                    Toast.makeText(CalculoPago.this, "Seleccionar un Cargo en Primer Empleado", Toast.LENGTH_LONG).show();
                ...
                else  if ("".equals(TxtApellido2.getText().toString()))
                {
                    ...
                    Toast.makeText(CalculoPago.this, "Seleccionar un Cargo en Segundo Empleado", Toast.LENGTH_LONG).show();
                ...
                else  if ("".equals(TxtApellido3.getText().toString()))
                {
                    ...
                    Toast.makeText(CalculoPago.this, "Seleccionar un Cargo en Tercer Empleado", Toast.LENGTH_LONG).show();
                ...
                //---------------------------------------------------------------------------------------------------------------------------
                    ...
                    Intent intent = new Intent(CalculoPago.this,MostrarSalario.class);
