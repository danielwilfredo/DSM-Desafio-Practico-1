...
public class mostrar_salario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TxtNombre2.setText(Nombre2+" "+Apellido2+" - "+Cargo2);
        TxtNombre3.setText(Nombre3+" "+Apellido3+" - "+Cargo3);
        ...
        if (Cargo1.equals(C1) && Cargo2.equals(C2) && Cargo3.equals(C3)){
            Toast.makeText(mostrar_salario.this, "NO HAY BONO", Toast.LENGTH_LONG).show();
        ...
        BtnRegresarSalario.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent= new Intent(mostrar_salario.this,calculo_pago.class);
